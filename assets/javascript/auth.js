...
firebase.auth().onAuthStateChanged(firebaseUser => {
    if (firebaseUser) {
        ...
        //we save the useremail in sessionstorage to be used when we need to save the news for the user in firebase database
        sessionStorage.setItem("news", JSON.stringify(firebaseUser.email));
        //
        ...
        //make logout btn invisible if user not login

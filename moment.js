...
// line 3 define function callpollen(ip)
// the function callpollen(ip) performas an Ajax request using the queryURL
// we get the result by calling the queryURL
// we define the variable weatherPollenAQI for the air quality Index
// we define the weather levels with the index number
// we append the result to the DOM
